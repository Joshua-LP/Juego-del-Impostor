...
const PISTAS_RELACIONADAS = {
    ...
    // DC Comics
    "Batman": ["murciélago", "Gotham", "justicia", "Bruce Wayne", "capa negra"],
    "Superman": ["volar", "Krypton", "Clark Kent", "capa roja", "fuerza"],
    "Wonder Woman", ["guerrera", "lasso", "Themyscira", "amazona", "tiara"],
    "The Flash": ["velocidad", "rayo", "Central City", "tiempo", "corredor"],
    "Joker": ["risa", "caos", "cartas", "verde", "locura"],
    "Harley Quinn": ["payaso", "bate", "coletas", "caos", "Puddin"],
    // Presidentes Vacados del Perú
    "Alberto Fujimori": ["autogolpe", "Vladivideo", "década", "autoritario", "reelección"],
    "Pedro Castillo": ["maestro", "rural", "lápiz", "Cajamarca", "golpe"],
    "Martín Vizcarra": ["vacancia", "obras", "Richard Swing", "audios", "popularidad"],
    "Pedro Pablo Kuczynski": ["Odebrecht", "renuncia", "economista", "PPK", "videgaray"],
    "Alan García": ["bala", "APRA", "segundo gobierno", "metro", "corrupción"],
    // Palabras durante el sexo
    "Sí baby": ["placer", "aprobación", "pasión", "deseo", "afirmación"],
    "Más rápido": ["velocidad", "intensidad", "ritmo", "prisa", "movimiento"],
    "Ay que rico": ["satisfacción", "gusto", "placer", "deleite", "goce"],
    "No pares": ["continuidad", "ritmo", "seguir", "mantener", "constancia"],
    "Te amo": ["sentimiento", "amor", "cariño", "corazón", "conexión"],
    // Palabras cuando comes
    "Está delicioso": ["sabor", "gusto", "cocina", "chef", "placer"],
    "Qué rico": ["sabrosura", "gusto", "deleite", "hambre", "satisfacción"],
    "Mmm sabroso": ["textura", "condimento", "cocinar", "receta", "paladar"],
    "Más por favor": ["repetir", "porción", "hambre", "antojo", "servir"],
    "Está picante": ["ají", "ardor", "lengua", "especias", "fuego"],
    // Novelas
    "Pasión de Gavilanes": ["hermanos", "hacienda", "venganza", "amor", "Colombia"],
    "Betty la Fea": ["EcoModa", "amor", "transformación", "Colombia", "secretaria"],
    "La Reina del Flow": ["música", "reggaeton", "venganza", "cárcel", "Colombia"],
    "Café con Aroma de Mujer": ["plantación", "amor", "Colombia", "café", "romance"],
    "Narcos": ["Pablo Escobar", "Medellín", "DEA", "cocaína", "cartel"],
    // Pokemon
    "Pikachu": ["eléctrico", "amarillo", "Ash", "ratón", "descargas"],
    "Charizard": ["fuego", "dragón", "volar", "llamas", "naranja"],
    "Mewtwo": ["psíquico", "laboratorio", "poderoso", "clonación", "legendario"],
    "Rayquaza": ["serpiente", "cielo", "verde", "legendario", "viento"],
    "Arceus": ["creador", "dios", "universo", "pokémon original", "todopoderoso"],
    // Música/Canciones
...
function generateHintForWord(word, category) {
    ...
    const categoryHints = {
        ...
        "DC Comics": ["superhéroe", "justicia", "gotham", "metrópolis", "poder"],
        "Presidentes Vacados del Perú": ["política", "crisis", "congreso", "vacancia", "Perú"],
        "Palabras Durante el Sexo": ["pasión", "intimidad", "deseo", "placer", "amor"],
        "Palabras Cuando Comes": ["sabor", "hambre", "cocina", "restaurante", "delicia"],
        "Novelas Famosas": ["drama", "romance", "televisión", "historia", "personaje"],
        "Pokémon": ["batalla", "capturar", "evolución", "entrenador", "criatura"]
    };
